class DeclarationHistoryModel {
  ...
  DeclarationHistoryModel.fromJson(Map<String, dynamic> json) {
    code = json['Code'];
    ...
    benhIdList =
        json['BenhIdList'] == null ? [] : json['BenhIdList'].cast<String>();
    // comandGroupId = json['ComandGroupId'];
    isSendNotity = json['IsSendNotity'];
    benhIdListStr = json['BenhIdListStr'] == null
        ? []
        : json['BenhIdListStr'].cast<String>();
